(function() {
  ...
  var Application = function() {
    ...
    var Splash = new UI.Card({
      title:     'SWEN weeks',
      subtitle:  'The AngelHack',
      body:      "Displays the current top News."
    });
    
    Splash.show();
      
    this.SN = new SwenNews();
  ...
  Application.prototype.showCurrentStory = function() {
    var app = this;
    this.SN.getStory(this.current, function(data) {
      app.showStory(data);
    });
  };
  
  Application.prototype.showNextStory = function() {
    if (this.current + 1 < this.SN.top.length) {
      this.current++;
    }
  ...
  Application.prototype.load = function() {
      var app = this;
    app.SN.refreshStories(function() {
      app.showCurrentStory();
    });    
  };
